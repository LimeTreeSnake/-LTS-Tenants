...
namespace Tenants.Language {
    public static class Translate {
        ...
        public static string TenantPassionOther => "LTSTenantPassionOther".Translate();
        ...
        public static string AutoRenewTenancy => "LTSTenancyAutoRenew".Translate();
        public static string AutoRenewTenancyDesc => "LTSTenancyAutoRenewDesc".Translate();
        public static string AutoRenewContractText(Pawn pawn) => "LTSContractAutoRenewText".Translate(pawn.Named("PAWN"));
        //Settings
        ...
        public static string SameIdeo => "LTSSameIdeo".Translate();
        public static string SameIdeoDesc => "LTSSameIdeoDesc".Translate();
        ...
        public static string AllowArchite => "LTSAllowArchite".Translate();
        public static string AllowArchiteDesc => "LTSAllowArchiteDesc".Translate();
        public static string NonFlesh => "LTSAllowNonFlesh".Translate();
        public static string NonFleshDesc => "LTSAllowNonFleshDesc".Translate();
    }
}
